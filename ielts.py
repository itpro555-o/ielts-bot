...
СТРОГИЕ ПРАВИЛА:
1. НИКАКИХ ЗВЕЗДОЧЕК, РЕШЕТОК И СТРЕЛОК. Только чистый текст. НЕЛЬЗЯ ИСПОЛЬЗОВАТЬ СИМВОЛЫ #, *, @.
...
def send_welcome(message):
    bot.reply_to(message, "IELTS Trainer Mode ON 🎓\nПришли эссе (Task 1 или Task 2), и я оценю, проанализирую его по критериям IELTS и подскажу, что можно исправить. Также можешь попросить меня дать задания для практики!")
